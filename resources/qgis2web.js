...
map.getView().fit([11803628.475524, -242135.691091, 11827605.760656, -228550.706207], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA INTERAKTIF ANALISIS KESESUAIAN PENGGUNAAN TANAH TERHADAP RTRW KOTA PANGKALPINANG TAHUN 2020</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (673 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta interaktif ini menyajikan hasil analisis kesesuaian antara penggunaan tanah eksisting dengan arahan Rencana Tata Ruang Wilayah (RTRW) Kota Pangkalpinang. Analisis dilakukan melalui proses overlay spasial antara data penggunaan tanah tahun 2020 dengan data pola ruang RTRW.<br />Hasil analisis diklasifikasikan menjadi tiga tingkat kesesuaian yaitu Sesuai, Belum Ditentukan, dan Tidak Sesuai untuk memberikan gambaran hubungan antara kondisi pemanfaatan tanah aktual dengan rencana pemanfaatan ruang. Informasi ini dapat digunakan sebagai pendukung dalam pengawasan pemanfaatan ruang, evaluasi tata ruang, serta penguatan governansi pertanahan berbasis informasi geospasial.';
            }
